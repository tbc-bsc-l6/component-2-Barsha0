...
<head>
    ...
    <style>
        ...
        .card {
            ...
            margin: 40px auto; /* Center the card with top and bottom margin */
        ...
        .form-group input[type="file"] {
            width: calc(100% - 10px);
            padding: 8px;
            border: 1px solid #4D5CAD; /* Blue border */
        ...
        .form-group input[type="submit"] {
            background-color: #631CCE; /* Purple */
        ...
        .form-group input[type="submit"]:hover {
            background-color: #4D5CAD; /* Blue on hover */
